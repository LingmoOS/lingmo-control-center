...
Q_DECLARE_METATYPE(PanelItemInfo)
Q_DECLARE_METATYPE(PanelItemInfos)

class PanelDBusProxy : public QObject
{
    Q_OBJECT
public:
    explicit PanelDBusProxy(QObject *parent = nullptr);
...
public Q_SLOTS:
    ...
    QDBusPendingReply<PanelItemInfos> plugins();
...
Q_SIGNALS:
    ...
    void IconSizeChanged(uint iconSize) const;
